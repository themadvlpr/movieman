	...
	return (
		<>
			<button
				...
				className='flex items-center gap-2 px-3 py-1.5 sm:mr-3 md:mr-5 rounded-lg bg-zinc-900/50 border border-white/5 hover:border-white/20 transition-all text-zinc-400 hover:cursor-text hover:scale-115 duration-500'
			>
				<Search size={18} />
