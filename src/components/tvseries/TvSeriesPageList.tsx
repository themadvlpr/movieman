...
export default function TvSeriesPageList({ status, tvData, hasNextPage, loaderRef, activeCategory, viewMode, handleItemClick, userId, t, setActiveCategory }: { status: string, tvData: any[], hasNextPage: boolean, loaderRef: any, activeCategory: string, viewMode: string, handleItemClick: () => void, userId: string, t: any, setActiveCategory: (category: 'popular' | 'topRated' | 'genres') => void }) {
    return (
        <>
            {status === 'pending' ? (
