				...
				<Providers locale={locale}>
					<div className='flex flex-col min-h-dvh'>
						...
						<main className='flex-1 flex flex-col'>
							<Suspense fallback={
								<div className="fixed top-[52px] sm:top-[76px] left-0 w-full h-[2px] bg-zinc-800 z-50 overflow-hidden">
									<div className="h-full bg-white w-1/3 animate-[shimmer_1.5s_infinite] origin-left"
										style={{ animationName: 'loader-shimmer' }} />
								</div>
							}>
								<PageTransition>
									{children}
